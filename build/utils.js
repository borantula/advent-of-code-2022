...
function parseToMatrix(str) {
    return parseLinesToArray(str).map(function (e) { return e.split(''); });
}
exports.parseToMatrix = parseToMatrix;
function parseToNumberMatrix(str) {
    return parseLinesToArray(str).map(function (e) { return e.split('').map(Number); });
}
exports.parseToNumberMatrix = parseToNumberMatrix;
function backToMatrixString(m) {
    return m.map(function (row) { return row.join(''); }).join('\n');
}
...
function readFileContent(fileName) {
    if (fileName === void 0) { fileName = 'testData.txt'; }
    return __awaiter(this, void 0, void 0, function () {
        var file;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs.readFile(path.join(__dirname, fileName))];
                case 1:
                    file = _a.sent();
